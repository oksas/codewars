/*
Kata written by: toast565  =====  Write a function, factory, that takes a number as its parameter and returns another function.
...
function factory(x){
    return function (arrIn) {
      return arrIn.map(function (val) {
        return val * x;
      });
    };
}
